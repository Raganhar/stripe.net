...
{
    public class when_creating_a_markedplace_charge_with_a_token
    {
        ...
        Establish context = () =>
        {
            ...
            //_stripeCustomer = stripeAccountService.Create(test_data.stripe_customer_create_options.ValidCard());
